...
const file_clientpb_client_proto_rawDesc = "" +
	...
	"\aOptions\x18\x04 \x01(\tR\aOptions\"\xd0\x0e\n" +
	...
	"\x0fDiversityConfig\x18\xad\x02 \x01(\v2\x1e.clientpb.BuildDiversityConfigR\x0fDiversityConfig\"\xa4\x04\n" +
	...
	"\fScanDuration\x18\x04 \x01(\tR\fScanDuration\"\x87\x02\n" +
	"\fDllHijackReq\x12*\n" +
...
var file_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 137)
var file_clientpb_client_proto_goTypes = []any{
	...
	(*DllHijackReq)(nil),           // 96: clientpb.DllHijackReq
	(*DllHijack)(nil),              // 97: clientpb.DllHijack
	(*BackdoorReq)(nil),            // 98: clientpb.BackdoorReq
	(*Backdoor)(nil),               // 99: clientpb.Backdoor
	(*ShellcodeEncodeReq)(nil),     // 100: clientpb.ShellcodeEncodeReq
	(*ShellcodeEncode)(nil),        // 101: clientpb.ShellcodeEncode
	(*ShellcodeEncoderMap)(nil),    // 102: clientpb.ShellcodeEncoderMap
	(*ExternalGenerateReq)(nil),    // 103: clientpb.ExternalGenerateReq
	(*Builders)(nil),               // 104: clientpb.Builders
	(*Builder)(nil),                // 105: clientpb.Builder
	(*HTTPC2Configs)(nil),          // 106: clientpb.HTTPC2Configs
	(*C2ProfileReq)(nil),           // 107: clientpb.C2ProfileReq
	(*HTTPC2ConfigReq)(nil),        // 108: clientpb.HTTPC2ConfigReq
	(*HTTPC2Config)(nil),           // 109: clientpb.HTTPC2Config
	(*HTTPC2ServerConfig)(nil),     // 110: clientpb.HTTPC2ServerConfig
	(*HTTPC2ImplantConfig)(nil),    // 111: clientpb.HTTPC2ImplantConfig
	(*HTTPC2Cookie)(nil),           // 112: clientpb.HTTPC2Cookie
	(*HTTPC2Header)(nil),           // 113: clientpb.HTTPC2Header
	(*HTTPC2URLParameter)(nil),     // 114: clientpb.HTTPC2URLParameter
	(*HTTPC2PathSegment)(nil),      // 115: clientpb.HTTPC2PathSegment
	(*Credential)(nil),             // 116: clientpb.Credential
	(*Credentials)(nil),            // 117: clientpb.Credentials
	(*Crackstations)(nil),          // 118: clientpb.Crackstations
	(*CrackstationStatus)(nil),     // 119: clientpb.CrackstationStatus
	(*CrackSyncStatus)(nil),        // 120: clientpb.CrackSyncStatus
	(*CrackBenchmark)(nil),         // 121: clientpb.CrackBenchmark
	(*CrackTask)(nil),              // 122: clientpb.CrackTask
	(*Crackstation)(nil),           // 123: clientpb.Crackstation
	(*CUDABackendInfo)(nil),        // 124: clientpb.CUDABackendInfo
	(*OpenCLBackendInfo)(nil),      // 125: clientpb.OpenCLBackendInfo
	(*MetalBackendInfo)(nil),       // 126: clientpb.MetalBackendInfo
	(*CrackCommand)(nil),           // 127: clientpb.CrackCommand
	(*CrackConfig)(nil),            // 128: clientpb.CrackConfig
	(*CrackFiles)(nil),             // 129: clientpb.CrackFiles
	(*CrackFile)(nil),              // 130: clientpb.CrackFile
	(*CrackFileChunk)(nil),         // 131: clientpb.CrackFileChunk
	(*MonitoringProviders)(nil),    // 132: clientpb.MonitoringProviders
	(*MonitoringProvider)(nil),     // 133: clientpb.MonitoringProvider
	(*ResourceID)(nil),             // 134: clientpb.ResourceID
	(*CertificatesReq)(nil),        // 135: clientpb.CertificatesReq
	(*CertificateData)(nil),        // 136: clientpb.CertificateData
	(*CertificateInfo)(nil),        // 137: clientpb.CertificateInfo
	nil,                            // 138: clientpb.TrafficEncoderMap.EncodersEntry
	nil,                            // 139: clientpb.ExternalImplantConfig.EncodersEntry
	nil,                            // 140: clientpb.ImplantBuilds.ConfigsEntry
	nil,                            // 141: clientpb.ImplantBuilds.ResourceIDsEntry
	nil,                            // 142: clientpb.ImplantBuilds.StagedEntry
	nil,                            // 143: clientpb.WebsiteAddContent.ContentsEntry
	nil,                            // 144: clientpb.Website.ContentsEntry
	nil,                            // 145: clientpb.Host.ExtensionDataEntry
	nil,                            // 146: clientpb.ShellcodeEncoderMap.EncodersEntry
	nil,                            // 147: clientpb.CrackSyncStatus.ProgressEntry
	nil,                            // 148: clientpb.CrackBenchmark.BenchmarksEntry
	nil,                            // 149: clientpb.Crackstation.BenchmarksEntry
	(*commonpb.File)(nil),          // 150: commonpb.File
	(*commonpb.Request)(nil),       // 151: commonpb.Request
	(*commonpb.Response)(nil),      // 152: commonpb.Response
}
var file_clientpb_client_proto_depIdxs = []int32{
	...
	150, // 5: clientpb.ImplantConfig.Assets:type_name -> commonpb.File
	23,  // 6: clientpb.ImplantConfig.DiversityConfig:type_name -> clientpb.BuildDiversityConfig
	150, // 7: clientpb.TrafficEncoder.Wasm:type_name -> commonpb.File
	138, // 8: clientpb.TrafficEncoderMap.Encoders:type_name -> clientpb.TrafficEncoderMap.EncodersEntry
	...
	109, // 13: clientpb.ExternalImplantConfig.HTTPC2:type_name -> clientpb.HTTPC2Config
	139, // 14: clientpb.ExternalImplantConfig.encoders:type_name -> clientpb.ExternalImplantConfig.EncodersEntry
	150, // 15: clientpb.ExternalImplantBinary.File:type_name -> commonpb.File
	140, // 16: clientpb.ImplantBuilds.Configs:type_name -> clientpb.ImplantBuilds.ConfigsEntry
	141, // 17: clientpb.ImplantBuilds.ResourceIDs:type_name -> clientpb.ImplantBuilds.ResourceIDsEntry
	142, // 18: clientpb.ImplantBuilds.staged:type_name -> clientpb.ImplantBuilds.StagedEntry
	...
	151, // 33: clientpb.NamedPipesReq.Request:type_name -> commonpb.Request
	152, // 34: clientpb.NamedPipes.Response:type_name -> commonpb.Response
	151, // 35: clientpb.TCPPivotReq.Request:type_name -> commonpb.Request
	152, // 36: clientpb.TCPPivot.Response:type_name -> commonpb.Response
	...
	150, // 39: clientpb.Generate.File:type_name -> commonpb.File
	151, // 40: clientpb.MSFReq.Request:type_name -> commonpb.Request
	151, // 41: clientpb.MSFRemoteReq.Request:type_name -> commonpb.Request
	...
	151, // 44: clientpb.GetSystemReq.Request:type_name -> commonpb.Request
	...
	151, // 47: clientpb.MigrateReq.Request:type_name -> commonpb.Request
	151, // 48: clientpb.CreateTunnelReq.Request:type_name -> commonpb.Request
	151, // 49: clientpb.CloseTunnelReq.Request:type_name -> commonpb.Request
	...
	143, // 58: clientpb.WebsiteAddContent.Contents:type_name -> clientpb.WebsiteAddContent.ContentsEntry
	144, // 59: clientpb.Website.Contents:type_name -> clientpb.Website.ContentsEntry
	83,  // 60: clientpb.Websites.Websites:type_name -> clientpb.Website
	2,   // 61: clientpb.Loot.FileType:type_name -> clientpb.FileType
	150, // 62: clientpb.Loot.File:type_name -> commonpb.File
	86,  // 63: clientpb.AllLoot.Loot:type_name -> clientpb.Loot
	88,  // 64: clientpb.Host.IOCs:type_name -> clientpb.IOC
	145, // 65: clientpb.Host.ExtensionData:type_name -> clientpb.Host.ExtensionDataEntry
	...
	151, // 69: clientpb.DllHijackReq.Request:type_name -> commonpb.Request
	152, // 70: clientpb.DllHijack.Response:type_name -> commonpb.Response
	151, // 71: clientpb.BackdoorReq.Request:type_name -> commonpb.Request
	152, // 72: clientpb.Backdoor.Response:type_name -> commonpb.Response
	3,   // 73: clientpb.ShellcodeEncodeReq.Encoder:type_name -> clientpb.ShellcodeEncoder
	151, // 74: clientpb.ShellcodeEncodeReq.Request:type_name -> commonpb.Request
	152, // 75: clientpb.ShellcodeEncode.Response:type_name -> commonpb.Response
	146, // 76: clientpb.ShellcodeEncoderMap.Encoders:type_name -> clientpb.ShellcodeEncoderMap.EncodersEntry
	22,  // 77: clientpb.ExternalGenerateReq.Config:type_name -> clientpb.ImplantConfig
	105, // 78: clientpb.Builders.Builders:type_name -> clientpb.Builder
	...
	109, // 81: clientpb.HTTPC2Configs.configs:type_name -> clientpb.HTTPC2Config
	109, // 82: clientpb.HTTPC2ConfigReq.C2Config:type_name -> clientpb.HTTPC2Config
	110, // 83: clientpb.HTTPC2Config.ServerConfig:type_name -> clientpb.HTTPC2ServerConfig
	111, // 84: clientpb.HTTPC2Config.ImplantConfig:type_name -> clientpb.HTTPC2ImplantConfig
	113, // 85: clientpb.HTTPC2ServerConfig.Headers:type_name -> clientpb.HTTPC2Header
	112, // 86: clientpb.HTTPC2ServerConfig.Cookies:type_name -> clientpb.HTTPC2Cookie
	114, // 87: clientpb.HTTPC2ImplantConfig.ExtraURLParameters:type_name -> clientpb.HTTPC2URLParameter
	113, // 88: clientpb.HTTPC2ImplantConfig.Headers:type_name -> clientpb.HTTPC2Header
	115, // 89: clientpb.HTTPC2ImplantConfig.PathSegments:type_name -> clientpb.HTTPC2PathSegment
	5,   // 90: clientpb.Credential.HashType:type_name -> clientpb.HashType
	116, // 91: clientpb.Credentials.Credentials:type_name -> clientpb.Credential
	123, // 92: clientpb.Crackstations.Crackstations:type_name -> clientpb.Crackstation
	6,   // 93: clientpb.CrackstationStatus.State:type_name -> clientpb.States
	120, // 94: clientpb.CrackstationStatus.Syncing:type_name -> clientpb.CrackSyncStatus
	147, // 95: clientpb.CrackSyncStatus.Progress:type_name -> clientpb.CrackSyncStatus.ProgressEntry
	148, // 96: clientpb.CrackBenchmark.Benchmarks:type_name -> clientpb.CrackBenchmark.BenchmarksEntry
	127, // 97: clientpb.CrackTask.Command:type_name -> clientpb.CrackCommand
	149, // 98: clientpb.Crackstation.Benchmarks:type_name -> clientpb.Crackstation.BenchmarksEntry
	124, // 99: clientpb.Crackstation.CUDA:type_name -> clientpb.CUDABackendInfo
	126, // 100: clientpb.Crackstation.Metal:type_name -> clientpb.MetalBackendInfo
	125, // 101: clientpb.Crackstation.OpenCL:type_name -> clientpb.OpenCLBackendInfo
	...
	130, // 108: clientpb.CrackFiles.Files:type_name -> clientpb.CrackFile
	12,  // 109: clientpb.CrackFile.Type:type_name -> clientpb.CrackFileType
	131, // 110: clientpb.CrackFile.Chunks:type_name -> clientpb.CrackFileChunk
	133, // 111: clientpb.MonitoringProviders.providers:type_name -> clientpb.MonitoringProvider
	136, // 112: clientpb.CertificateInfo.info:type_name -> clientpb.CertificateData
	...
	134, // 115: clientpb.ImplantBuilds.ResourceIDsEntry.value:type_name -> clientpb.ResourceID
