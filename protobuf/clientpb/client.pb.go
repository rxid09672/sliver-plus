...
type ImplantConfig struct {
	...
	TLSFingerprint          string `protobuf:"bytes,311,opt,name=TLSFingerprint,proto3" json:"TLSFingerprint,omitempty"`         // "chrome", "firefox", "ios", "android", "edge", "safari"
	MalleableC2Profile      string `protobuf:"bytes,312,opt,name=MalleableC2Profile,proto3" json:"MalleableC2Profile,omitempty"` // Path to Malleable C2 profile file (future)
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
