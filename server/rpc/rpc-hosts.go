...
// HostScan - Scan network targets and discover hosts
func (rpc *Server) HostScan(ctx context.Context, req *clientpb.HostScanReq) (*clientpb.HostScanResults, error) {
	return core.ScanHosts(req)
}
